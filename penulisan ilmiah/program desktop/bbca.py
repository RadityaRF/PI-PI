...
#loading train data
X_df = pd.read_csv('D:\Program Files\penulisan ilmiah\program desktop\dataset\BBCA.JK (3).csv')
...
Y_df = pd.read_csv('D:\Program Files\penulisan ilmiah\program desktop\dataset\BBCA.JK (3).csv')
